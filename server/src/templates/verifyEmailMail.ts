...
export const verifyEmailMail = ({ otp }: VerifyEmailMailProps) => {
	return `
												...
												>
													...
													>
														...
														<p style="padding-bottom: 16px">
															Thanks for signing up with Headless Commerce. Please use the verification code
														...
														<p style="padding-bottom: 16px">
															Thanks,<br />Headless Commerce team
														</p>
													</div>
												</div>
												<div
