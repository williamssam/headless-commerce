											...
											<td style="padding: 40px 0px 0px;">
												...
												>
													...
													>
														...
														<p style="padding-bottom: 16px">
															We've received a request to reset
															the password for this user account.
														</p>
														<p style="padding-bottom: 16px">
															<a
																href="${config.client_url}/reset-password?token=${token}&id=${id}"
																target="_blank"
														...
														<p style="padding-bottom: 16px">
															If you didn't ask to reset your
															password, you can ignore this
															email.
														</p>
														<p style="padding-bottom: 16px">
															Thanks,<br />Headless Commerce
														</p>
													</div>
												</div>
												<div
